...
@property (strong, nonatomic) SDCLoginVC *viewController; // Registro facebook
@property (strong,nonatomic)UINavigationController *glucoseRegisterNC; // Este lo declaro aqui para tener acceso desde point view
